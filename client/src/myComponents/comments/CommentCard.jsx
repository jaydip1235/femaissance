...
const CommentCard = (props) => {
    ...
    const deleteComment=async()=>{
        try {
                if(currentUserId!==props.commentedBy) alert("Only author can delete comment!");
                    ...
                    await axios.delete(`https://femaissance.herokuapp.com/api/posts/deletecomment/${props.ownId}`,config);
    ...
    const likeComment=async()=>{
        try {
            ...
            // alert(props.ownId);
            await axios.put(`https://femaissance.herokuapp.com/api/posts/comment/like`,{commentId:props.ownId},config);
            window.location.reload();
        } catch (error) {
            console.log(error);
        }
