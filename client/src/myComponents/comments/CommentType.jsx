    ...
    const submitComment=async()=>{
        try {
            if(comment&&comment.trim()){
                ...
                if(id&&type=="reply"){
                    console.log(_id,' ',id);
                    await axios.post(`https://femaissance.herokuapp.com/api/posts/reply/${_id}`,{body:comment,parentId:id},config);
                    alert("Reply created!");
                }
                    ...
                    if(commentedBy!==currentUserId) alert("Only the author can edit comment!");
                        ...
                        console.log("fgfxgx");
                        await axios.put(`https://femaissance.herokuapp.com/api/posts/updatecomment/${id}`,{body:comment},config);
                        alert("Comment updated!");
                    }
                }
                else{
                    await axios.post(`https://femaissance.herokuapp.com/api/posts/comment/${_id}`,{body:comment},config);
