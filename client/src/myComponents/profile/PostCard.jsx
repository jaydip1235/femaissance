...
const PostCard = ({title,body,photo,id,userid}) => {
    ...
    useEffect(()=>{
        ...
        axios.get('https://femaissance.herokuapp.com/api/user/getuser',config)
        .then(res=>{
    ...
    const deletePost=async(id)=>{
        try {
            ...
            await axios.delete(`https://femaissance.herokuapp.com/api/posts/delete/${id}`,config);
            alert("Post deleted!");
