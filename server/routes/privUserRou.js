...
const {getUser,getOtherUser,updateProfile,followUnfollow,postsOfAParticularUser,getAllUsers,getSelectedUser,informUser}=require('../controllers/privUserCon');
